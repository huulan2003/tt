...
<html lang="en">
  <head>
    ...
    <link href="./bootstrap/css/styles2.css" rel="stylesheet">
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg  navbar-expand-md navbar-light bg-warning bg-gradient fixed-top">
      <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#topNav" aria-controls="topNav" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <a class="navbar-brand" href="index.php">Van Lang Book Store</a>
        </div>
    ...
    <!-- Main jumbotron for a primary marketing message or call to action -->
      <div class="container">
        <h1>Welcome to VanLang Bookstore</h1>
        <hr>
      </div>
    <?php } ?>
